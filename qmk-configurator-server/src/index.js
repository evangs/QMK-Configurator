...
app.post('/build', (req, res) => {
  ...
  f.setupFirmware(keyboard.config, keyboard.rules, keyboard.configKeymap, keyboard.keymap, keyboard.indicators, keyboard.staticIndicators, keyboard.rotaryEncoders, fd => {
