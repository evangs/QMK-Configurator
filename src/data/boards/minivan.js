...
minivan.indicators = [
  [
    ...
    {red: 215, green: 30, blue: 125, action: 'L1', type: 'layer'}
  ],
  [
    {red: 32, green: 104, blue: 255, action: 'L2', type: 'layer'}
  ],
  [
...
minivan.keymap = function(ks, zones) {
  const keymap = []
  keymap.push(ks.row1)
  keymap.push(ks.row2)
  keymap.push(ks.row3)
  keymap.push(ks.leftHand[zones[0].value].concat(ks.row4).concat(ks.rightHand[zones[1].value]))
  return keymap
}
...
minivan.layers = [{
  ...
  layoutId: '0',
  name: 'Default',
  keys: minivan.keySections[0]
}, {
  id: '1',
  layoutId: '0',
  name: 'Shifted',
  keys: minivan.keySections[1]
}, {
  id: '2',
  layoutId: '0',
  name: 'Numerics',
  keys: minivan.keySections[2]
}, {
  id: '3',
  layoutId: '0',
  name: 'Game Lock Layer',
  keys: minivan.keySections[3]
}]
