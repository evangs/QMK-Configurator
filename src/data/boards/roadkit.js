...
roadkit.keymap = function(ks, zones) {
  const keymap = []
  keymap.push(ks.row1.concat(ks.plus[zones[0].value]))
  keymap.push(ks.row2.concat(ks.plus2[zones[0].value]))
  keymap.push(ks.row3.concat(ks.enter[zones[1].value]))
  keymap.push(ks.zero[zones[2].value].concat(ks.row4).concat(ks.enter2[zones[1].value]))
  return keymap
}
...
roadkit.layers = [{
  ...
  layoutId: '0',
  name: 'Default',
  keys: roadkit.keySections[0]
}, {
  id: '1',
  layoutId: '0',
  name: 'Directions',
  keys: roadkit.keySections[1]
}, {
  id: '2',
  layoutId: '0',
  name: 'Media',
  keys: roadkit.keySections[2]
}, {
  id: '3',
  layoutId: '0',
  name: 'System',
  keys: roadkit.keySections[3]
}]

export default roadkit
