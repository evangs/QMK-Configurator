...
fortysevenhundred = {};
KEYBOARDS.push(fortysevenhundred);

fortysevenhundred.id = 'fortysevenhundred_rev1';

// config
fortysevenhundred.config = {
    vendorId: '0xFEAE',
    productId: '0x8860',
...
fortysevenhundred.configKeymap.keys = [
...
fortysevenhundred.configKeymap.positions = [
...
fortysevenhundred.keymap = function() {
    var keymap = [];
    var layer = [];
    var ks;
    var i;
